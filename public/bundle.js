var app = (function () {
    ...
    /* Form.svelte generated by Svelte v3.55.1 */
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(26:0) {#each movies as movie}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const movies = [
    		...
    		{ name: "Loki", available: 9, quantity: 0 },
    		{
    			name: "Cruela",
    			available: 2,
    			quantity: 0
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h2 = element("h2");
    			h2.textContent = "Películas";
    			t1 = space();
    			create_component(form.$$.fragment);
    			add_location(h2, file$1, 5, 2, 65);
